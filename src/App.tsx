...
import { GamerMascot, MiniGamerIcon } from './components/GamerMascot';
import { Gamepad2, Mail, Phone, MapPin, Code, Target, Sparkles, Star, Zap, Trophy, Briefcase, Rocket, ExternalLink } from 'lucide-react';
...
export default function App() {
  ...
  const professionalProjects = [
    {
      ...
      company: 'Sandsoft',
      period: '2023 - 2024',
      description: 'Real-time multiplayer strategy game that combines backpack inventory management and merge mechanics for an innovative gaming experience.',
    ...
    },
    {
      ...
      company: 'Sandsoft',
      period: '2023 - 2024',
      description: 'Merge Rumble: Epic Real-Time PvP Strategy Game with merging mechanism.',
    ...
    },
    {
      ...
      company: 'UMXStudio',
      period: '2022 - 2023',
      description: 'Multiplayer racing game for iOS, Android, and Huawei platforms',
    ...
    },
    {
      ...
      tags: ['VR', 'Quest', 'Unity'],
      link: 'https://play.google.com/store/apps/details?id=com.quicksand.mergerumble&hl=enhttps://queststoredb.com/app/union-coop-6246938002023894/',
      color: 'from-green-500 to-teal-600'
    },
    {
      title: 'Toyota Showroom',
      company: 'Immeraic (CGEVO)',
      period: '2019 - 2022',
      description: 'touch screen application for a showroom in the automotive industry',
    ...
    },
    {
      ...
      period: '2019 - 2022',
      description: 'Augmented reality application with realtime movement controls',
      tags: ['AR', 'Mobile', 'PC'],
    ...
    },
    {
      ...
      company: 'Immergic (CGEVO)',
      period: '2019 - 2022',
      description: 'Virtual reality action game inspired by fruit ninja',
    ...
    },
    {
      ...
      company: '5DVR',
      period: '2015 - 2017',
      description: 'VR flyting experience amoung the world famous landmarks',
  ...
  const personalProjects = [
    {
      title: 'Smashable',
      description: 'Global Game Jam 2018 - Development, level design and visual effects',
    ...
    {
      title: 'Naughty Soul',
      description: 'Global Game Jam 2021 - Level design, core mechanics and sound design',
    ...
    {
      title: 'Break it',
      description: 'Global Game Jam 2020 - Game level design and development',
    ...
    {
      title: 'Camper Van',
      description: 'Van coloring mobile game for creative entertainment',
      tags: ['Mobile', 'Casual'],
      link: 'https://drive.google.com/file/d/1AtOL_1bDx2sW-WK--0JCq-udN_Sp0Nef/view?usp=sharinghttps://drive.google.com/file/d/19SgZb0PnDOJs40bbYOCpyEUwWhU8ZcbB/view',
      color: 'from-blue-400 to-cyan-500'
    },
    {
      title: 'Hadotopia',
      description: 'Kids language teaching app with educational gameplay',
      tags: ['Educational', 'Mobile'],
      link: 'https://drive.google.com/file/d/1AtOL_1bDx2sW-WK--0JCq-udN_Sp0Nef/view?usp=sharinghttps://drive.google.com/file/d/1XsY95TYjV6QfPPCsMedZWcEnZ7Hcbj1O/view',
      color: 'from-red-400 to-orange-500'
    },
    {
      title: 'Prevent Disaster',
      description: 'Hyper casual puzzle game with engaging mechanics',
      tags: ['Hyper Casual', 'Puzzle'],
      link: 'https://play.google.com/store/apps/details?id=com.DefaultCompany.DisasterPuzzle',
      color: 'from-indigo-400 to-purple-500'
    },
    {
      title: 'Waitress Run',
      description: 'Hyper casual runner game with smooth gameplay',
      tags: ['Hyper Casual', 'Runner'],
      link: 'https://play.google.com/store/apps/details?id=com.Ponky.WaitressRun',
    ...
    {
      title: 'Poinky',
      description: 'ITI graduation project - Complete game development',
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row items-center gap-12 max-w-6xl mx-auto">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  >
                    Crafting legendary gaming experiences with over a decade of expertise
                  </motion.p>
              ...
              {/* Achievements Bar */}
              <motion.div
                className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-20 max-w-5xl mx-auto w-full"
              ...
              >
                {achievements.map((achievement, index) => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.05, borderColor: 'rgba(56, 178, 172, 0.8)' }}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    ...
                    <div className="mt-8">
                      <div className="bg-black/50 backdrop-blur-md border-2 border-cyan-400/30 rounded-lg p-8">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h3 className="text-2xl text-cyan-400">Professional Journey</h3>
                        </div>
                        <div className="space-y-4 text-gray-300">
                          <p className="text-lg">
                            <span className="text-cyan-400">✦</span> Passionate Game Developer
                          </p>
                          <p className="text-lg">
                            <span className="text-purple-400">✦</span> 10+ Years of Experience
                          </p>
                          <p className="text-lg">
                            <span className="text-pink-400">✦</span> Senior Level Expertise
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="bg-gradient-to-br from-cyan-500/10 to-purple-600/10 backdrop-blur-md border-2 border-cyan-400/30 rounded-lg p-8">
                      ...
                      <p className="text-gray-300 text-lg leading-relaxed mb-4">
                        With over a decade of experience in the gaming industry, I bring a deep passion for creating 
                        immersive and engaging gaming experiences. My journey has been driven by an unwavering commitment 
                        to excellence and innovation.
                      </p>
                      <p className="text-gray-300 text-lg leading-relaxed">
                        From concept to completion, I thrive on transforming creative visions into interactive realities 
                        that captivate players around the world. Every project is an opportunity to push boundaries and 
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <div className="text-cyan-400">Innovation</div>
                      </motion.div>
                      <motion.div
                      ...
                      >
                        ...
                        <div className="text-purple-400">Performance</div>
                      </motion.div>
                    </div>
                  </motion.div>
                </div>
              ...
              <div className="max-w-7xl mx-auto w-full px-4">
                ...
                <div className="mb-16">
                  ...
                  >
                    ...
                    <h3 className="text-3xl text-cyan-400">Professional Work</h3>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {professionalProjects.map((project, index) => (
                      <motion.div
                        key={index}
                        className="bg-black/50 backdrop-blur-md border-2 border-cyan-400/30 rounded-lg p-6 hover:border-cyan-400 transition-all group relative overflow-hidden"
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: index * 0.05 }}
                        whileHover={{ scale: 1.03, y: -5 }}
                      >
                        <div className={`h-2 bg-gradient-to-r ${project.color} rounded-full mb-4`}></div>
                        <div className="flex items-start justify-between mb-2">
                          <h4 className="text-xl text-cyan-400">{project.title}</h4>
                          {project.link && (
                            <a
                              href={project.link}
                              target="_blank"
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.tags.map((tag, i) => (
                            <span key={i} className="bg-cyan-500/10 border border-cyan-400/30 px-2 py-1 rounded text-xs text-cyan-400">
                              {tag}
                            </span>
                          ))}
                        </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <h3 className="text-3xl text-purple-400">Personal Projects</h3>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {personalProjects.map((project, index) => (
                      <motion.div
                        key={index}
                        className="bg-black/50 backdrop-blur-md border-2 border-purple-400/30 rounded-lg p-6 hover:border-purple-400 transition-all group relative overflow-hidden"
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: 1, y: 0 }}
                      ...
                      >
                        <div className={`h-2 bg-gradient-to-r ${project.color} rounded-full mb-4`}></div>
                        <div className="flex items-start justify-between mb-2">
                          <h4 className="text-xl text-purple-400">{project.title}</h4>
                          {project.link && (
                            <a
                              href={project.link}
                              target="_blank"
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.tags.map((tag, i) => (
                            <span key={i} className="bg-purple-500/10 border border-purple-400/30 px-2 py-1 rounded text-xs text-purple-400">
                              {tag}
                            </span>
                          ))}
                        </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-3 justify-center">
                    {['Unity', 'C#', 'Game Design', 'AR/VR', 'Mobile Games', 'PC Games', 'Multiplayer', 'Performance Optimization', 'SDK Integration', 'Cross-platform', 'Team Leadership', 'Agile Development'].map((skill, i) => (
                      <motion.span
                        key={i}
                        ...
                        whileHover={{ scale: 1.1, borderColor: 'rgba(251, 191, 36, 1)' }}
                      >
                        {skill}
                      </motion.span>
                    ))}
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-black/50 backdrop-blur-md border-2 border-cyan-400/30 rounded-lg p-8 hover:border-cyan-400 transition-all group">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="text-cyan-400 text-lg">alaa.mohamed.hatata@gmail.com</div>
                        </div>
                      </div>
                      <a
                    ...
                    <div className="bg-black/50 backdrop-blur-md border-2 border-purple-400/30 rounded-lg p-8 hover:border-purple-400 transition-all group">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="text-purple-400 text-lg">+966509490874</div>
                        </div>
                      </div>
                      <a
                    ...
                    <div className="bg-black/50 backdrop-blur-md border-2 border-green-400/30 rounded-lg p-8 hover:border-green-400 transition-all group">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-green-400 text-lg">Saudi Arabia</div>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex flex-col items-center text-center h-full justify-center">
                      ...
                      <h3 className="text-2xl text-cyan-400 mb-4">Ready to Level Up?</h3>
                      <p className="text-gray-300 mb-6 text-lg">
                        Let's collaborate on your next gaming project and create something extraordinary together!
                      </p>
